...
export default function MilfordSound() {
  ...
  return (
    <section ref={sectionRef} className="relative h-screen w-full overflow-hidden">
      ...
      <img
        ref={bgRef}
        src="https://images.unsplash.com/photo-1469521669194-babb45599def?w=1920&q=80"
        alt="Milford Sound fjords"
      ...
      <div className="relative z-10 flex h-full w-full items-center justify-between px-8 md:px-16 lg:px-24">
        ...
        >
          <p className="text-sm font-medium uppercase tracking-widest text-glacial-dark">Day 7</p>
          <p className="mt-2 text-lg font-semibold text-white">Milford Sound</p>
          <p className="mt-1 text-sm leading-relaxed text-white/70">
            Scenic cruise through ancient fiords
          </p>
        </div>
      </div>
    </section>
