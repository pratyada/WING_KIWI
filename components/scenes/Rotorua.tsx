...
export default function Rotorua() {
  ...
  return (
    <section ref={sectionRef} className="relative h-screen w-full overflow-hidden">
      {/* Rotorua geothermal landscape */}
      <img
        ref={bgRef}
        src="https://images.unsplash.com/photo-1548546738-8509cb246ed3?w=1920&q=80"
        alt="Rotorua geothermal landscape"
      ...
      <div className="relative z-10 flex h-full w-full items-center justify-between px-8 md:px-16 lg:px-24">
        ...
        >
          <p className="text-sm font-medium uppercase tracking-widest text-amber">Day 3</p>
          <p className="mt-2 text-lg font-semibold text-white">Rotorua</p>
          <p className="mt-1 text-sm leading-relaxed text-white/70">
            Geothermal pools, Maori cultural evening, Redwoods Treewalk
          </p>
        </div>
      </div>
    </section>
